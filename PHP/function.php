...
*/
function Request_post ($url,$content,&$response) {
 ...
 * @param String $_GOOGLE_API_KEY		//googleKEY---身份Key
 * @param String $_URL								//推送url
 * @return google返回结果
 *
 * demo
 $info = '{
 //设备号
 "registration_ids" : ["APA91bHqQam4bLvcRfunSs4OdRb8qKClbtjKucRW8mElcWhfQuSD0ATeUWqG_46IcinbdWj6ddS0WfhkKSRi1kefZGzENYFL6fRxWwKDJqhf1ftdpzIeK2TJl_hD2at6xDvzcSwTBZDYUpKLuQB9q1rZKseXHSxCVg"],
		 "data" : {
		 "type": 1,
		 "msg_count" : 42 ,
		 "msg" : "789"
 ...
 */
function send_gcm_notify($content,$_GOOGLE_API_KEY,$_URL='https://android.googleapis.com/gcm/send') {
